          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{ route('barang_out.store') }}" method="post">
                    {{ csrf_field() }}
                  <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">No Surat Barang Keluar(SBK)</label>
                          <input type="text" class="form-control" name="no_sbk" required>
                        </div>
                      </div>
                    </div>
                    &nbsp
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="custom-select" style="width:300px;" id="sales" name="id_sales">
                              @if($sales->count())
                                @foreach($sales as $sales)
                                  <option value="{{ $sales->id}}">{{$sales->id}} - {{$sales->nama}}</option>
                                @endforeach    
                              @endif
                            </select>
                          </div>
